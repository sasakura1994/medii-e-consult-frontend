...
export const SeminarArchiveHeader: React.FC<Props> = ( { ticketCount }: Props ) =>
{
  ...
  return (
        <div
          className="flex w-full flex-col items-center rounded-lg pb-2 md:max-w-[960px] md:bg-white pt-11 md:pt-0"
        >
          ...
          <div className="mb-2 flex flex-col items-center justify-center md:flex-row w-full">
            <div>
