...
export const ConsultExampleActions: React.FC<Props> = ({
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex items-center text-sm ${isShortOnMobile ? 'bg-bg bg-none px-4 py-3 lg:px-0 lg:py-0' : ''}`}
        >
          <a
          ...
          {!isCommentButtonHidden && (
            ...
            >
              <img src="icons/comment.svg" width="24" height="24" className="ml-4 block" alt="" />
              <div className="ml-1">コメントする</div>
            </a>
          )}
        </div>
        <div className="flex items-center text-xs">
          <img src="icons/good_out.svg" width="18" height="18" alt="いいねの数" />
          ...
          {!isShowCommentsButtonHidden && (
            ...
            >
              <img src="icons/comment.svg" width="18" height="18" className="ml-4 block" alt="コメントの数" />
