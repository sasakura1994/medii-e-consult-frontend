    ...
    <div className="border-1 rounded-xs mt-10 -mb-10 w-full border bg-white pb-5 lg:mb-0 lg:px-16 lg:pb-6">
      <div className="mt-9 text-center">
        ...
        <div className="mx-auto mb-12 flex max-w-xs items-center justify-between">
          <img src="/icons/doctor2.svg" className="h-auto w-24" alt="" />
          <img src="/icons/medii.svg" className="h-auto w-16" alt="" />
          <img src="/icons/doctor3.svg" className="h-auto w-24" alt="" />
        </div>
        {!isInvited && (
          <div className="mb-8">
            現在、ご提出いただいた資料を確認中です。
