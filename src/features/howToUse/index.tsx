    ...
    <div className="flex justify-center bg-white lg:mt-6 lg:bg-transparent">
      <div className="hidden md:block">
        <p className="my-2 text-base text-gray-700">
          <Link href="#consult-sample">E-コンサルの事例集</Link>
        </p>
        <p className="text-base text-gray-700">
          <Link href="#use">E-コンサルの使い方</Link>
        </p>
        <div className="ml-2 align-baseline text-sm font-light">
          <p className="my-2">
            <Link href="#home">ホーム画面について</Link>
          </p>
          <p className="my-2">
            <Link href="#start">E-コンサルの始め方</Link>
          </p>
          <p className="my-2">
            <Link href="#resolve">E-コンサルの解決方法（質問受ける医師）</Link>
          </p>
          <p className="my-2">
            <Link href="#file">ファイル添付</Link>
          </p>
          <p>
            <Link href="#profile">プロフィールの変更</Link>
          </p>
          <p className="my-2">
            <Link href="#inquiry">お問合せ・ご要望</Link>
          </p>
        </div>
      </div>

      <div>
        <div className="mx-auto mb-12 ml-2 flex-wrap p-4 lg:max-w-2xl">
          <div className="mx-auto box-border w-full rounded-lg border-gray-300 bg-white pb-6 pt-6 text-center font-sans lg:border lg:shadow-lg">
            <div id="consult-sample" className="mb-4 text-2xl font-bold text-gray-700">
              E-コンサルの事例集
            </div>
            <div className="mx-6">
              <div className="mx-2 text-left align-baseline font-normal">リウマチ膠原病内科の先生へのコンサル例</div>
              <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
              <div className="flex items-center">
                <img src="images/howtouse/doctor.png" className="m-3 hidden h-28 md:block" />
                <div className="h-auto rounded-lg border border-gray-400 p-3 md:h-32">
                  <p className="text-left text-primary">30代妊娠希望の女性の関節リウマチ</p>
              ...
              <div className="mt-4 flex items-center">
                <img src="images/howtouse/doctor.png" className="m-3 hidden  h-28 md:block" />
                <div className="h-auto rounded-lg border border-gray-400 p-3 md:h-32">
                  <p className="text-left text-primary">40代女性抗核抗体80倍でHOMO/SPE陽性</p>
                  <p className="text-left">
              ...
              <div className="mt-4 flex items-center">
                <img src="images/howtouse/doctor.png" className="m-3 hidden h-28 md:block" />
                <div className="h-auto rounded-lg border border-gray-400 p-3 md:h-32">
                  <p className="text-left text-primary">70代男性 多発血管炎性肉芽腫症</p>
                  <p className="text-left">
                    PSL10mg内服中の方で、胆嚢炎に対する胆嚢摘出術を予定しています。ステロイドカバーについてご教示お願いいたします。
                  </p>
                </div>
              </div>
              <div id="use" className="my-14 mb-4 text-2xl font-bold text-gray-700">
                E-コンサルの使い方
              </div>
              <div id="home" className="mx-2 text-left align-baseline font-normal">
                ホーム画面について
              </div>
              <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
              ...
              <div id="start" className="mx-2 mt-10 text-left align-baseline font-normal">
                E-コンサルの始め方
              </div>
              <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
              <div className="text-left">
                ...
                <div className="my-10">
                  ...
                  <span>患者情報/患者背景/コンサル文を入力し、ルームを作成する</span>
                  <div className="h-2" />
              ...
              <div id="resolve" className="mx-2 mb-10 text-left align-baseline font-normal">
                E-コンサルの解決方法（質問受ける医師）
                <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
              ...
              <div id="file" className="mx-2 mb-10 text-left align-baseline font-normal">
                ファイル添付
                <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
                <p>「ファイル添付ボタン」を押下</p>
                <img src="images/howtouse/08.png" className="mx-auto" />
              </div>
              <div id="profile" className="mx-2 text-left align-baseline font-normal">
                プロフィールの変更
                <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
              ...
              <div id="inquiry" className="mx-2 mt-10  text-left align-baseline font-normal">
                お問合せ・ご要望
                <div className="mx-2 my-4 border-x-2 border-b border-gray-400 opacity-25" />
                <p className="text-sm">
