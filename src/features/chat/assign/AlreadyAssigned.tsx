      ...
      {consultExample && consultExampleMessages && (
        <>
          <div className="mt-6 pb-[120px]">
            <Container>
              <ConsultExampleDetail consultExample={consultExample} consultExampleMessages={consultExampleMessages} />
            </Container>
          </div>
          <div
          ...
          >
            <Link href={`/example/${consultExample.example_id}`}>
              <PrimaryButton className="text-sm">この事例のページへ行く</PrimaryButton>
            </Link>
            <div className="mt-4">
              <Link href="/examplelist">
                <OutlinedButton className="text-[11px] font-normal">事例集一覧を見る</OutlinedButton>
              </Link>
            </div>
          </div>
        </>
