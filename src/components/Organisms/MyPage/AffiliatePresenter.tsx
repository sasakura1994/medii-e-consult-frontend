...
type PresenterPropsType = {
  ...
  handleClickClipboard: () => void;
};

export const AffiliatePresenter: React.FC<PresenterPropsType> = React.memo(
  (props) => {
    const { handleClickDownload, handleClickClipboard } = props;
...
AffiliatePresenter.displayName = 'AffiliatePresenter';
