    ...
    <div className="bg-white pb-6 pt-20">
      <div className="flex flex-col justify-center gap-10 pl-20 md:flex-row md:gap-[126px] md:pl-0">
        <div className="flex flex-col justify-center gap-[40px] md:flex-row">
          <img src="images/side_logo.svg" alt="Medii E-コンサル" className="h-fit w-[156px]" />
        ...
        <div className="flex flex-col">
          {[
            ...
            <Link href={e.href} key={e.href} className="mb-4 text-[14px] font-bold text-primary">
              {e.label}
            </Link>
          ))}
        </div>
      ...
      <div>
        <p className="mt-4 text-center text-[11px] font-bold">©Medii, Inc. All Rights Reserved</p>
      </div>
    </div>
  );
};
