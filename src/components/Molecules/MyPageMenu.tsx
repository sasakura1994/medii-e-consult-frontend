...
const getActiveMenuItemStyle = (routePath: string, pathName: string): string => {
  ...
  return (
    <nav className={styles.mypage_nav}>
      <ul className={styles.mypage_menu}>
        <li className={getActiveMenuItemStyle(router.pathname, '/edit-profile')}>
        ...
        <li className={getActiveMenuItemStyle(router.pathname, '/point-history')}>
        ...
        <li className={getActiveMenuItemStyle(router.pathname, '/amazon-gift')}>
          <Link href="/amazon-gift">
            <a className={styles.mypage_menu__link}>
        ...
        <li className={getActiveMenuItemStyle(router.pathname, '/notify-settings')}>
          <Link href="/notify-settings">
            <a className={styles.mypage_menu__link}>
              <span>通知設定</span>
            </a>
          </Link>
