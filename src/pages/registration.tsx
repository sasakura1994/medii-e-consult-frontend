...
const Registration: NextPage = () => {
  ...
  return (
    <div className="bg-[url('/images/registration/bg.png')] md:py-14">
      {isSent ? (
        <div className="shadow-[0_4px_4px_rgb(0 0 / 25%)] 0 mx-auto flex w-fit items-stretch justify-center rounded-md border border-slate-300 bg-white py-4 px-8">
          <p>
        ...
        <div className="shadow-[0_4px_4px_rgb(0 0 / 25%)] 0 mx-auto flex flex-col items-stretch justify-center md:flex-row md:py-4">
          <img
