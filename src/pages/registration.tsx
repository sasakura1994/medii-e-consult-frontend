...
const GuideLink = ({ children, href }: { children: string; href: string }) => {
  return (
    <Link href={href}>
      <a className="text-sm text-guide-link underline mt-6">{children}</a>
    </Link>
  );
};
...
const Registration: NextPage = () => {
  ...
  return (
    <div className="bg-[url('/images/registration/bg.png')] md:py-14">
      {isSent ? (
        <div className="shadow-[0_4px_4px_rgb(0 0 0 / 25%)] mx-auto flex w-fit items-stretch justify-center rounded-md border border-slate-300 bg-white py-4 px-8">
          <p>
        ...
        <div className="shadow-[0_4px_4px_rgb(0 0 0 / 25%)] mx-auto flex flex-col items-stretch justify-center md:py-4 md:flex-row">
          <img
            src="/images/registration/left.png"
            className="max-w-[480px] bg-white hidden md:block"
          />
          <img
            src="/images/registration/mobile_main.png"
            className="max-w-[480px] bg-white md:hidden"
          />
          <div className="flex max-w-[480px] flex-col items-center justify-items-stretch bg-white md:pt-[64px] pl-[30px] pr-[48px] pb-14 md:pb-4">
