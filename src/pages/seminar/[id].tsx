...
const Seminar: NextPage = () => {
  ...
  return (
    <div
      className="bg-[url('/images/seminar/SP_back.png')] bg-cover bg-no-repeat pb-20
      lg:bg-[url('/images/seminar/PC_back.png')] lg:pt-32"
    >
        ...
        >
          {seminar?.movie_url ? (
            ...
            <img
              ...
              className="absolute left-0 right-0 top-[-79px] z-20 mx-auto aspect-video w-5/6 shadow-lg lg:static lg:mt-0 lg:w-full lg:max-w-[960px] lg:bg-white lg:pt-0 lg:shadow-none"
            />
          )}
          {!seminar?.movie_url && (
          ...
          <div className="flex flex-col items-center bg-white px-7 pb-10 lg:px-[60px]">
            <div className="mt-4 flex w-full flex-col items-center">
              <div className="flex w-full items-center justify-center rounded-md bg-[#e2e7ff] py-4">
                <div className="m-2 flex h-8 w-8 items-center justify-center rounded-full bg-primary lg:h-20 lg:w-20">
                  <img src="/images/seminar/video.svg" className="w-[19px] lg:w-auto" />
                </div>
            ...
            <div className="w-full  text-lg">
              ...
              <div className="border-b py-4">
                <div className="flex">
                  <p className="pr-4 text-2xl text-base text-primary lg:text-lg lg:font-bold">講師</p>
      ...
      {showModal && (
        <Modal setShowModal={setShowModal} className="lg:w-[800px]">
          <div className="align-center relative flex flex-col items-center bg-white px-6 py-4 lg:px-28 lg:py-20">
            ...
            <img className="hidden lg:block" src="/images/seminar/about_ticket_pc.png" />
            <img className="lg:hidden" src="/images/seminar/about_ticket_sp.png" />
          </div>
        </Modal>
      )}
      {isTicketConfirmDialogShown && (
