  ...
  return (
    <div className="mt-6 mb-12">
      <div className="mx-auto flex w-login-container max-w-login-container flex-col items-center border border-solid border-login-container-frame bg-white py-4">
        ...
        <TextField placeholder="メールアドレス" type="email"/>
        <TextField placeholder="パスワード" type="password" />
        <div className="mt-2">
        ...
        <div>
          <button className="my-4 rounded-full bg-primary py-2 px-14 text-white drop-shadow-[0_4px_10px_rgba(92,107,192,.3)]">
            ログイン
          </button>
        </div>
        <div>
          <button className="rounded-md border border-solid border-black py-2 px-10 inline-flex items-center mt-6">
              <AiFillApple className="inline" size="30" />Appleでログイン
          </button>
        </div>
      </div>
    </div>
